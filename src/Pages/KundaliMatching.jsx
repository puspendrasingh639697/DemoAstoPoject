...
import LandingPage from "../components/KundaliMatching/LandingPage";
import MatchingForm from "../components/KundaliMatching/MatchingForm";
import SeoPage from "../components/KundaliMatching/SeoPage";
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center justify-center text-center py-8 ">
          <div className="flex mx-auto">
            <div className="p-4">
              ...
              >
                Discover your kundali with our free kundali service.
              </motion.p>

              <motion.button
                onClick={() => navigate("/free-kundali")}
